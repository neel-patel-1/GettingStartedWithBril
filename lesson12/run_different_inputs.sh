...
deno run --allow-read=./examples --allow-write=. $TRACE_BRILI $INPUT_JSON -h ${H_THRESH} 8
echo "Before optimization: "
echo "-----------------------"
bril2txt < $INPUT_JSON
echo "Output:"
brili -p 8 < $INPUT_JSON
...
echo "After optimization (Target Input): "
echo "-----------------------"
...
echo "Before Optimization (Alternate Input): "
echo "-----------------------"
echo "Output:"
brili -p 4 < $INPUT_JSON

echo "After optimization (Alternate Input): "
echo "-----------------------"
python3 ./optimizations/optimize_and_insert_trace.py $INPUT_JSON | python3 ../bril/examples/tdce.py tdce+ > $OUTPUT
bril2txt < $OUTPUT
echo "Output:"
