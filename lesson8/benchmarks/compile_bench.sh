...
${CLANG} -c ${POLYBENCH_DIR}/utilities/polybench.c -o ${POLYBENCH_DIR}/utilities/polybench.o


${CLANG} -S -O1 -Xclang -disable-llvm-passes -emit-llvm ${INCLUDES} -S ${POLYBENCH_DIR}/linear-algebra/kernels/atax/atax.c -o ${POLYBENCH_DIR}/linear-algebra/kernels/atax/atax_time.ll
